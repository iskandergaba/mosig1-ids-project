//Here we get the ring topolofy from the input graph that is connected.
//We use repetitive nearest neighbour algorithm (same as nearest neigbhour, but checks the tours from every node and chooses the one with min length) <-TODO
...
public class RingNode
{
    ...
    public void sendLeft(Message msg,List<Node> nodes) throws IOException
    {   //Source is virtualid, index in the ring
